*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_ODATAV4_NPROP
*   generation date: 28.02.2025 at 19:12:23
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_ODATAV4_NPROP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_ODATAV4_NPROP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_ODATAV4_NPROP_EXTRACT
TOTAL = ZV_ODATAV4_NPROP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_ODATAV4_NPROP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_ODATAV4_NPROP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_ODATAV4_NPROP_EXTRACT
TOTAL = ZV_ODATAV4_NPROP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_ODATAV4_NPROP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_ODATAV4_NPROP'
...
TOTAL = ZV_ODATAV4_NPROP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_ODATAV4_NPROP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_ODATAV4_NPROP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_ODATAV4_NPROP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_ODATAV4_NPROP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_ODATAV4_NPROP_EXTRACT
TOTAL = ZV_ODATAV4_NPROP_TOTAL
